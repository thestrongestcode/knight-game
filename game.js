...
function getEnemyFrame(type, dir, animFrame) {
 ...
 if (dir === "up") {
  return { srcX: 0, srcY: 3 * s.frameH, fw: s.frameW, fh: s.frameH };
 }
...
function getFireFrame(frame) {
 ...
 const fw = sheet.naturalWidth / FIRE_SHEET.frames;
 return { srcX: frame * fw, srcY: 0, fw, fh: sheet.naturalHeight };
}
...
// ============================================================
// ENEMY SPRITE ANIMATION CONFIG
// ============================================================
const ENEMY_ANIM_SPEED = 8;
const ENEMY_SHEET = { animFrames: 4 };
